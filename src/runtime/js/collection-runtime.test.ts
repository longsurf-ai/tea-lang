// Purpose: Struct/collection state and history, provisional commit, request-Heap isolation,
...
describe('struct and collection state and commit integration', () => {
  ...
  test('an aborted first transaction reruns collection varip initialization', async () => {
    const sink = new Sink();
    let fail = true;
    const base = arrayStateModule();
    const module = testModule({
