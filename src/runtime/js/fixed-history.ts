...
import {JSRuntime, type JSRuntimeOptions, type StepResult} from './runtime';
...
/** Execute independent fixed-history bindings in caller order. */
export async function executeFixedHistory(
  module: JSModule,
  ...
  for (const inputs of bindings) {
    let execution: FixedHistoryExecution | null = null;
    try {
