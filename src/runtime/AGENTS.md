...
- Generated artifacts construct ordinary Arrow schemas; standard IPC remains available for serialization and defensive schema copying. Do not structuredClone Arrow objects. Execution captures private configuration/schema copies once; ordinary binding and Node inspection do not clone modules. Independent executions explicitly clone or load their own modules; immutable empty Values and code identity may be shared.
